...
#include <Disks/S3/TryReadBufferFromS3.h>
...
TryReadBufferFromS3::TryReadBufferFromS3(
...
bool TryReadBufferFromS3::nextImpl()
{
...
off_t TryReadBufferFromS3::seek(off_t offset_, int whence)
{
    if (impl)
...
off_t TryReadBufferFromS3::getPosition()
{
    return offset - available();
}

std::unique_ptr<ReadBuffer> TryReadBufferFromS3::initialize()
{
