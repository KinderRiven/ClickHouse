...
void RemoteCachedOnDiskReadBufferFromFile::appendFilesystemCacheLog(
    const FileSegment::Range & file_segment_range, RemoteCachedOnDiskReadBufferFromFile::ReadType type)
{
    ...
    switch (type)
    {
        case RemoteCachedOnDiskReadBufferFromFile::ReadType::CACHED:
            elem.cache_type = FilesystemCacheLogElement::CacheType::READ_FROM_CACHE;
            break;
        case RemoteCachedOnDiskReadBufferFromFile::ReadType::REMOTE_FS_READ_BYPASS_CACHE:
            elem.cache_type = FilesystemCacheLogElement::CacheType::READ_FROM_FS_BYPASSING_CACHE;
            break;
        case RemoteCachedOnDiskReadBufferFromFile::ReadType::REMOTE_FS_READ_AND_PUT_IN_CACHE:
...
RemoteCachedOnDiskReadBufferFromFile::ImplementationBufferPtr
RemoteCachedOnDiskReadBufferFromFile::getCacheReadBuffer(size_t offset) const
{
...
RemoteCachedOnDiskReadBufferFromFile::ImplementationBufferPtr
RemoteCachedOnDiskReadBufferFromFile::getRemoteFSReadBuffer(FileSegmentPtr & file_segment, ReadType read_type_)
{
    switch (read_type_)
    {
...
RemoteCachedOnDiskReadBufferFromFile::ImplementationBufferPtr
RemoteCachedOnDiskReadBufferFromFile::getReadBufferForFileSegment(FileSegmentPtr & file_segment)
{
...
RemoteCachedOnDiskReadBufferFromFile::ImplementationBufferPtr
RemoteCachedOnDiskReadBufferFromFile::getImplementationBuffer(FileSegmentPtr & file_segment)
{
...
bool RemoteCachedOnDiskReadBufferFromFile::completeFileSegmentAndGetNext()
{
...
void RemoteCachedOnDiskReadBufferFromFile::predownload(FileSegmentPtr & file_segment)
{
...
bool RemoteCachedOnDiskReadBufferFromFile::updateImplementationBufferIfNeeded()
{
...
bool RemoteCachedOnDiskReadBufferFromFile::writeCache(char * data, size_t size, size_t offset, FileSegment & file_segment)
{
    Stopwatch watch(CLOCK_MONOTONIC);
...
size_t RemoteCachedOnDiskReadBufferFromFile::getTotalSizeToRead()
{
...
std::optional<size_t> RemoteCachedOnDiskReadBufferFromFile::getLastNonDownloadedOffset() const
{
...
void RemoteCachedOnDiskReadBufferFromFile::assertCorrectness() const
{
